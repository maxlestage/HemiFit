...
//  HemiFit
//
//  Catalogue d'exercices pour une hémiparésie droite avec forte
//  spasticité, déplacement en fauteuil roulant et équilibre très
//  altéré.
//
...
enum CategorieExercice: String, CaseIterable, Identifiable {
    ...
    var titre: String {
        switch self {
        case .massage: "Massage et détente"
        case .sensoriel: "Éveil sensoriel"
        case .main: "Main et doigts"
    ...
    /// Symbole SF associé à la famille d'exercices.
    var symbole: String {
        switch self {
        case .massage: "water.waves"
        case .sensoriel: "dot.radiowaves.left.and.right"
        case .main: "hand.raised"
...
enum Realisation: String, CaseIterable, Identifiable {
    case autonome
    case tiercePersonne
    ...
    var titre: String {
        switch self {
        case .autonome: "En autonomie"
        case .tiercePersonne: "Avec une tierce personne"
        }
    }
    ...
    var court: String {
        switch self {
        case .autonome: "Seul"
        case .tiercePersonne: "Avec de l'aide"
        }
    }

    var symbole: String {
        switch self {
        case .autonome: "person"
        case .tiercePersonne: "person.2"
        }
    }
}
...
struct Exercice: Identifiable, Hashable {
    ...
    let etapes: [String]
    /// Dosage lisible, ex. « 3 ouvertures, tenir 30 s ».
    let dosage: String
...
enum Catalogue {
    ...
    static func seanceDuJour(date: Date = .now) -> Seance {
        ...
        case 3: // mardi
            return Seance(
                ...
                description: "On reconstruit la force du bras gauche, celui qui porte tout, et on entretient le droit.",
                exercices: ["detente-respiration", "force-gauche-poussees", "force-gauche-tirage", "force-gauche-rotateurs", "force-droite-isometrique"].map(exercice),
                realisation: .autonome
            )
        case 6: // vendredi
            return Seance(
        ...
        case 7: // samedi
            return Seance(
                ...
                description: "Gainage, cuisses et endurance : ce qui rend les transferts plus sûrs et les journées moins lourdes.",
                exercices: ["detente-respiration", "force-tronc-gainage", "force-tronc-resistance", "force-jambes-isometrique", "force-endurance"].map(exercice),
                realisation: .autonome
            )
        case 4: // mercredi
            return Seance(
    ...
    static func seanceDuSoir() -> Seance {
        Seance(
            ...
            exercices: ["aide-massage-bras", "aide-epaule", "aide-coude-poignet", "aide-doigts", "aide-hanche-genou", "aide-cheville-mollet", "aide-drainage-jambes", "aide-installation-nuit"].map(exercice),
            realisation: .tiercePersonne
        )
    }
}

...
const CONSEILS: { titre: string; texte: string }[] = [
  ...
  },
  {
    ...
    texte:
      "Pendant les exercices, regardez votre main ou votre jambe droite bouger, même quand c'est la main gauche qui fait le travail. Voir le mouvement aide le cerveau à le réapprendre.",
  },
  {

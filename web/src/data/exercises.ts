...
export const EXERCICES: Exercice[] = [
  ...
  },
  {
    ...
    realisation: "autonome",
    objectif:
      "Détendre le mollet, le muscle qui tire le pied en pointe et entretient l'équin.",
    etapes: [
  ...
  },
  {
    ...
    realisation: "autonome",
    objectif:
      "Détendre le muscle qui tire le pied vers l'intérieur : c'est lui le principal responsable du varus.",
    etapes: [
  ...
  },
  {
    ...
    realisation: "autonome",
    objectif:
      "Solliciter les muscles qui tournent le pied vers l'extérieur : ce sont eux qui manquent quand le pied part en varus.",
    etapes: [
  ...
  },
  {
    ...
    realisation: "autonome",
    objectif:
      "Une attelle se supporte beaucoup mieux sur un pied réchauffé, massé et déjà étiré.",
    etapes: [
  ...
  },
  {
    ...
    realisation: "autonome",
    objectif:
      "Repérer tôt un point de compression : c'est la précaution la plus importante avec une attelle.",
    etapes: [
  ...
  },
  {
    ...
    realisation: "tierce-personne",
    objectif:
      "Étirer l'équin ET le varus : remonter le pied ne suffit pas, il faut aussi tourner la plante vers l'extérieur.",
    etapes: [
